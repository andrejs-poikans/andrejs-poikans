...
let renderBlock = (block, index, md) => {
  ...
  // Images!
    ...
    let imageItem = `
        <li class="${image}">
            <div class = "img-box" data-thumb="${
              block.image.thumb.url
            }" data-large="${block.image.large.url}">
...
function setupSectionNavigation() {
  ...
  document
    .querySelectorAll(".solo button, .collaborative button")
    .forEach((btn) => {
